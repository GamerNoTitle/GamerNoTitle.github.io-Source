...
![Workers](https://cdn1.tianli0.top/gh/Vikutorika/assets@master/img/Cloudflare-Workers/into-workers.png)

进入到Workers后，点击Create a Worker来创建你的第一个JS

![Create a Worker](https://cdn1.tianli0.top/gh/Vikutorika/assets@master/img/Cloudflare-Workers/Workers-Interface.png)

然后在workers界面的左边，填入你的JS代码，这时候就需要万能反代代码QAQ

![Worker Editor](https://cdn1.tianli0.top/gh/Vikutorika/assets@master/img/Cloudflare-Workers/Workers-Edit.png)
