...
![](https://assets.bili33.top/img/CTF-in-College-5/Xshell-20220607-230127.png?download=true)
...
![](https://assets.bili33.top/img/CTF-in-College-5/vmware-20220607-231140.png?download=true)
...
![](https://assets.bili33.top/img/CTF-in-College-5/HD-Player-20220607-231533.png?download=true)
...
![](https://assets.bili33.top/img/CTF-in-College-5/Xshell-20220607-231853.png?download=true)

这样就算是运行了，然后我们打开安装的软件，我们的msfconsole会提示肉鸡上线

![](https://assets.bili33.top/img/CTF-in-College-5/Xshell-20220607-231955.png?download=true)

这时可以用`sessions`命令查看在线的肉鸡

![](https://assets.bili33.top/img/CTF-in-College-5/Xshell-20220607-232045.png?download=true)

用`session -i <id>`就可以控制肉鸡啦

我这里就可以用`session -i 1`来通过第一个端口控制模拟器，使用`screenshot`命令进行截图

![](https://assets.bili33.top/img/CTF-in-College-5/KOsQYAQc.jpeg)
