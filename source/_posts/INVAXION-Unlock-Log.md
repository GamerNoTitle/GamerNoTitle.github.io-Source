...
tags: Tech
categories: Tech
cover: https://cdn.jsdelivr.net/gh/GamerNoTitle/Picture-repo-v1@master/img/INVAXION-Unlock-Log/Cover.png
---

> PS：音灵解锁补丁是我在高考前1个月左右的时候摸的，具体可以看Commit记录√

![](https://cdn.jsdelivr.net/gh/GamerNoTitle/Picture-repo-v1@master/img/INVAXION-Unlock-Log/Announcement.png)

音灵在2021.2.5宣布停运，我直到五月左右上游戏的时候才发现，我卡在了加载页面，翻了一下讨论区才发现，游戏停运了

![](https://cdn.jsdelivr.net/gh/GamerNoTitle/Picture-repo-v1@master/img/INVAXION-Unlock-Log/Loading.png)

但是我还在讨论区里找到了这个

[![](https://cdn.jsdelivr.net/gh/GamerNoTitle/Picture-repo-v1@master/img/INVAXION-Unlock-Log/Unlock-Level.png)](steamcommunity.com/app/921630/discussions/0/5350815203296872967/)
...
![注：本图是解锁完成后的注册表](https://cdn.jsdelivr.net/gh/GamerNoTitle/Picture-repo-v1@master/img/INVAXION-Unlock-Log/Regedit-Theme.png)
...
![注：本图是解锁完成后的注册表](https://cdn.jsdelivr.net/gh/GamerNoTitle/Picture-repo-v1@master/img/INVAXION-Unlock-Log/Regedit-Char.png)

我就去翻了一下文件，在`音灵 INVAXION\INVAXION_Data\StreamingAssets`这个目录下找到了所有的角色文件，在文件名上附有ID

![](https://cdn.jsdelivr.net/gh/GamerNoTitle/Picture-repo-v1@master/img/INVAXION-Unlock-Log/File-Char.png)
