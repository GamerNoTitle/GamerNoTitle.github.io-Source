...
![初始化库和安装依赖](https://assets.bili33.top/img/hexo-deploy-guide/Powershell-runtime-install.png)
...
![CNAME文件](https://assets.bili33.top/img/hexo-deploy-guide/CNAME-Create.png)

并且在CNAME文件中填写你的域名

![CNAME](https://assets.bili33.top/img/hexo-deploy-guide/CNAME.png)
...
![404](https://assets.bili33.top/img/hexo-deploy-guide/404.png)
...
![Google Webmaster](https://assets.bili33.top/img/hexo-deploy-guide/sitemap-google.png)

![Google Search Result](https://assets.bili33.top/img/hexo-deploy-guide/sitemap-google-search.png)
