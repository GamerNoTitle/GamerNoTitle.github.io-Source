...
tags: [Tech, Customize]
categories: Tech
cover: https://assets.bili33.top/img/Valine-customize/cover.png
---
...
![Valine官方JS](https://assets.bili33.top/img/Valine-customize/Valine-js-Official.png)
...
![CDN搜索](https://assets.bili33.top/img/Valine-customize/Valine-Original-CDN-Search.png)

我们将这里的CDN的内容直接删掉，留空

接着我们搜索valine自带的表情标签，而第一个的表情标签是smile，我这里就直接搜索smile，这样可以直接定位到表情列表的头部

![表情列表搜索](https://assets.bili33.top/img/Valine-customize/Valine-Stickers-List.png)
...
def main():
    ...
    for i in findAllFile(base):
        linklist.append('custom{}: "https://assets.bili33.top/img/BQB/{}",'.format(num,i))
        num=num+1
...
![生成表情列表](https://assets.bili33.top/img/Valine-customize/Sticker-List-Generate.png)
...
![搜索有关字段](https://assets.bili33.top/img/Valine-customize/Valine-Mail-Search.png)

我们找到下图中我鼠标所在的位置，回车换行

![换行位置](https://assets.bili33.top/img/Valine-customize/Valine-Mail-Enter.png)
...
![搜索有关字段](https://assets.bili33.top/img/Valine-customize/Valine-UI-Text.png)
