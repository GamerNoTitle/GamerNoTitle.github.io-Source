...
![版本选择](https://cdn.bili33.top/gh/Vikutorika/assets@master/img/FODI/Onemanager-Step1.png)

第一步安装的时候选择MS（中国版选择CN，如果你喜欢搞事情，你也可以选择MSC自己申请api，我就是懒，就不自己申请api了）

然后登陆自己的微软账户，接着就会弹出自己的refresh_token，这不就搞定了refresh_token啦？！

![refresh_token获取](https://cdn.bili33.top/gh/Vikutorika/assets@master/img/FODI/refresh-token-in-install.png)

如果你没有及时复制你自己的refresh_token，你也可以到你自己heroku项目的变量下复制

![refresh_token in Heroku](https://cdn.bili33.top/gh/Vikutorika/assets@master/img/FODI/refresh-token-heroku.png)
...
![cloudflare editor](https://cdn.bili33.top/gh/Vikutorika/assets@master/img/FODI/workers-editor.png)
...
```
完成界面：
![cloudflare editor](https://cdn.bili33.top/gh/Vikutorika/assets@master/img/FODI/Success.png)
