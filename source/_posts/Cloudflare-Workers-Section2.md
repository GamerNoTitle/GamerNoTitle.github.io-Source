...
![workers-in-domain](https://assets.bili33.top/img/Cloudflare-Workers/workers-in-domain.png)
在本界面中，上面的两个按钮点击Add Route
![Workers-Panel](https://assets.bili33.top/img/Cloudflare-Workers/Workers-Panel.png)
...
![](https://assets.bili33.top/img/Cloudflare-Workers/Result.png)
